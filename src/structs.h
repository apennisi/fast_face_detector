...
namespace ffd
{
    ...
    enum Type{FFD_MAX, FFD_MAXG, FFD_MS, FFD_COVER};
    enum OvrDnm{FFD_UNION, FFD_MIN};
    enum ColorSpace{FFD_HSV, FFD_LUV, FFD_RGB, FFD_ORIG, FFD_GRAY};
    enum PadWith{FFD_NONE, FFD_REPLICATE};
